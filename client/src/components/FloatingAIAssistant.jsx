    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {!isOpen && (
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white p-3.5 rounded-full shadow-lg transition-transform hover:scale-105 flex items-center gap-2 font-medium text-xs border border-blue-500"
        >
          <Sparkles className="w-4 h-4" />
          <span>HireNova AI</span>
        </button>
      )}
