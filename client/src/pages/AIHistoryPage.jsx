  ...
  return (
    <div className="min-h-screen bg-[#EFE9FE] flex text-[#1A1A2E] font-sans antialiased">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-purple-200/60 pb-5 sm:pb-6">
            ...
            {history.length > 0 && (
              <button 
                ...
                className="px-3.5 sm:px-4 py-2 rounded-2xl bg-rose-50 border border-rose-200 text-rose-600 font-bold text-xs hover:bg-rose-100 transition-all flex items-center gap-1.5 cursor-pointer self-start sm:self-auto"
              >
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-3.5 sm:p-4 shadow-sm flex flex-col lg:flex-row gap-3 sm:gap-4 justify-between items-stretch lg:items-center">
          
          {/* Category Tabs */}
          <div className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto scrollbar-none [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] py-0.5 w-full lg:w-auto">
            <button
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 w-full lg:w-auto">
            <div className="relative flex-1 sm:w-64 lg:w-60 min-w-0">
            ...
            <div className="flex items-center gap-1.5 bg-slate-50 border border-slate-200 rounded-xl px-2.5 py-2 shrink-0">
